"""
In this module, a graphic view is added.
...
class SendCommand:
    ...
    def __init__(self):
        ...
        interface.add_from_file('Module3_GraphicGUI.glade')
        ...
        self.DrawArea = interface.get_object('DrawArea')
    ...
    def on_DrawArea_button_press_event(self, widget, event):
        print 'clicked'
    ...
    def expose(self, widget, event):
        ...
        cr.rectangle(175, 150, 75, 100)
        cr.stroke_preserve()

        cr = widget.window.cairo_create()
        cr.rectangle(175, 215, 10, 35)
        cr.rectangle(240, 215, 10, 35)
        cr.fill()
